...
clean:
	rm -f raw* *~;cd src;make clean;cd ..; rm -f read_cinrad proc_radar
dataclean:
	rm -f fort.* raw* qced* limit* radar_info_in.txt radar_info_out.txt radar*dist.txt radar*used.txt *.3dv
tar:
